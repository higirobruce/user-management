...
export class AvailabilityController {
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden. You do not have permission to create availabilities.',
  })
  async create(
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden. You do not have permission to access availabilities.',
  })
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden. You do not have permission to access all availabilities.',
  })
  async findAll() {
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden. You do not have permission to update this availability.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'All availabilities have been successfully deleted.',
  })
  @ApiResponse({
    status: 403,
    description:
      'Forbidden. You do not have permission to delete all availabilities.',
  })
  async deleteAll(@CurrentUser() user: User) {
    if (user.role !== UserRole.ADMIN) {
      throw new ForbiddenException(
        'You are not allowed to delete all availabilities.',
      );
    }
